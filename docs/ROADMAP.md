...
| `D-004` | In progress | One-time browser-extension pairing, persistent token-hash authentication, local API hardening, stable extension resources, and version `0.4.0`. |
